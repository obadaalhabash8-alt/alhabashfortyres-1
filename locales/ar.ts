const ar = {
  ...
  story: {
    ...
    body: 'بدأت قصة شركة الحبش للإطارات في عام ١٩٦٧ على يد المؤسس الأول، بمحل صغير وحلم كبير. على مدى أكثر من خمسة عقود، نمت الشركة من محل واحد إلى ثلاثة فروع متكاملة، تخدم آلاف العملاء سنوياً بأعلى معايير الجودة والأمانة.',
  },
